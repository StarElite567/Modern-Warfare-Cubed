...
public class VZ58Factory {
    ...
    public Item createGun(CommonProxy commonProxy) {
        return new Weapon.Builder()
                ...
                .withCompatibleAttachment(Attachments.VZ58Hanguard, true,(model) -> {
                })
                .withCompatibleAttachment(Attachments.VZ58Stock, true,(model) -> {
                })
                .withCompatibleAttachment(Attachments.VZ58Grip, true,(model) -> {
                })
                .withCompatibleAttachment(Magazines.VZ58Mag, (model) -> {
                })
                .withCompatibleAttachment(AuxiliaryAttachments.VZ58action, true, (model) -> {
                })
                ...
                .withTextureNames("vz58")
                .withRenderer(new WeaponRenderer.Builder()
                        .withModel(new vz58())
                        .withActionPiece(AuxiliaryAttachments.VZ58action)
